...
sleep(1)
print('Vamos começar!')
print('Digite: \n1. para \033[31mPedra\033[m \n2. para \033[32mPapel\033[m  \n3. para \033[33mTesoura\33[m')
escolha = str(input('escolha entre Pedra, Papel e Tesoura, e tente vencer o computador! ')).strip().capitalize()
escolha = escolha.replace('1', 'Pedra')
escolha = escolha.replace('2', 'Papel')
escolha = escolha.replace('3', 'Tesoura')
